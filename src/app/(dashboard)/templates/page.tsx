    ...
    <div className="mx-auto max-w-4xl p-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Templates used for lead notifications in campaigns</p>
        </div>
        <Link
          href="/templates/new"
      ...
      {templates.length === 0 ? (
        ...
        <div className="space-y-2">
          {templates.map((t) => (
            <div key={t.id} className="flex items-center gap-4 rounded-xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
